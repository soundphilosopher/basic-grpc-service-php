...
class FieldDescriptorProto extends \Google\Protobuf\Internal\Message
{
    ...
    protected $name = null;
    /**
     * Generated from protobuf field <code>optional int32 number = 3 [json_name = "number"];</code>
     */
    protected $number = null;
    /**
     * Generated from protobuf field <code>optional .google.protobuf.FieldDescriptorProto.Label label = 4 [json_name = "label"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.protobuf.FieldDescriptorProto.Type type = 5 [json_name = "type"];</code>
     */
    protected $type = null;
    /**
     ...
     * namespace).
     *
     * Generated from protobuf field <code>optional string type_name = 6 [json_name = "typeName"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional string extendee = 2 [json_name = "extendee"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional string default_value = 7 [json_name = "defaultValue"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional int32 oneof_index = 9 [json_name = "oneofIndex"];</code>
     */
     ...
     * it to camelCase.
     *
     * Generated from protobuf field <code>optional string json_name = 10 [json_name = "jsonName"];</code>
     */
    protected $json_name = null;
    /**
     * Generated from protobuf field <code>optional .google.protobuf.FieldOptions options = 8 [json_name = "options"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional bool proto3_optional = 17 [json_name = "proto3Optional"];</code>
     */
     ...
     *           will be used. Otherwise, it's deduced from the field's name by converting
     *           it to camelCase.
     *     @type \Google\Protobuf\Proto\FieldOptions $options
    ...
    {
        GPBUtil::checkEnum($var, \Google\Protobuf\Proto\FieldDescriptorProto\Label::class);
        $this->label = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Protobuf\Proto\FieldDescriptorProto\Type::class);
        $this->type = $var;
    ...
    /**
     * Generated from protobuf field <code>optional .google.protobuf.FieldOptions options = 8 [json_name = "options"];</code>
     * @return \Google\Protobuf\Proto\FieldOptions|null
     */
    ...
    /**
     * Generated from protobuf field <code>optional .google.protobuf.FieldOptions options = 8 [json_name = "options"];</code>
     * @param \Google\Protobuf\Proto\FieldOptions $var
     * @return $this
     */
    public function setOptions($var)
    {
        GPBUtil::checkMessage($var, \Google\Protobuf\Proto\FieldOptions::class);
        $this->options = $var;
