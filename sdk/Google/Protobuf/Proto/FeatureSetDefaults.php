...
{
    /**
     * Generated from protobuf field <code>repeated .google.protobuf.FeatureSetDefaults.FeatureSetEditionDefault defaults = 1 [json_name = "defaults"];</code>
     */
    private $defaults;
    /**
     ...
     *
     * Generated from protobuf field <code>optional .google.protobuf.Edition minimum_edition = 4 [json_name = "minimumEdition"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.protobuf.Edition maximum_edition = 5 [json_name = "maximumEdition"];</code>
     */
     ...
     *
     *     @type \Google\Protobuf\Proto\FeatureSetDefaults\FeatureSetEditionDefault[] $defaults
    ...
    /**
     * Generated from protobuf field <code>repeated .google.protobuf.FeatureSetDefaults.FeatureSetEditionDefault defaults = 1 [json_name = "defaults"];</code>
     * @return RepeatedField<\Google\Protobuf\Proto\FeatureSetDefaults\FeatureSetEditionDefault>
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .google.protobuf.FeatureSetDefaults.FeatureSetEditionDefault defaults = 1 [json_name = "defaults"];</code>
     * @param \Google\Protobuf\Proto\FeatureSetDefaults\FeatureSetEditionDefault[] $var
     * @return $this
     */
    public function setDefaults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Protobuf\Proto\FeatureSetDefaults\FeatureSetEditionDefault::class);
        $this->defaults = $arr;
