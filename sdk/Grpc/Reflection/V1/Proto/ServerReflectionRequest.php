 ...
 *
 * Generated from protobuf message <code>grpc.reflection.v1.ServerReflectionRequest</code>
 */
class ServerReflectionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \Grpc\Reflection\V1\Proto\ExtensionRequest $file_containing_extension
     ...
     * Find a proto file by the file name.
     *
     * Generated from protobuf field <code>string file_by_filename = 3 [json_name = "fileByFilename"];</code>
     * @return string
     */
     ...
     * (e.g. <package>.<service>[.<method>] or <package>.<type>).
     *
     * Generated from protobuf field <code>string file_containing_symbol = 4 [json_name = "fileContainingSymbol"];</code>
     * @return string
     */
     ...
     * message type with the given field number.
     *
     * Generated from protobuf field <code>.grpc.reflection.v1.ExtensionRequest file_containing_extension = 5 [json_name = "fileContainingExtension"];</code>
     * @return \Grpc\Reflection\V1\Proto\ExtensionRequest|null
     */
     ...
     *
     * Generated from protobuf field <code>.grpc.reflection.v1.ExtensionRequest file_containing_extension = 5 [json_name = "fileContainingExtension"];</code>
     * @param \Grpc\Reflection\V1\Proto\ExtensionRequest $var
     * @return $this
     */
    public function setFileContainingExtension($var)
    {
        GPBUtil::checkMessage($var, \Grpc\Reflection\V1\Proto\ExtensionRequest::class);
     ...
     * <package>.<type>
     *
     * Generated from protobuf field <code>string all_extension_numbers_of_type = 6 [json_name = "allExtensionNumbersOfType"];</code>
     * @return string
     */
     ...
     * checked.
     *
     * Generated from protobuf field <code>string list_services = 7 [json_name = "listServices"];</code>
     * @return string
     */
