...
use Grpc\Reflection\V1\Proto\ServerReflectionInterface;
use Grpc\Reflection\V1\Proto\ServerReflectionRequest;
use Grpc\Reflection\V1\Proto\ServerReflectionResponse;
use Grpc\Reflection\V1\Proto\FileDescriptorResponse;
use Grpc\Reflection\V1\Proto\ExtensionNumberResponse;
use Grpc\Reflection\V1\Proto\ListServiceResponse;
use Spiral\RoadRunner\GRPC;
use App\Utils\ServiceRegistry;

final class GrpcReflectionService implements ServerReflectionInterface
{
